...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/blue-forest-0b1e)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/blue-forest-0b1e
```

A live public deployment of this template is available at [https://blue-forest-0b1e.templates.workers.dev](https://blue-forest-0b1e.templates.workers.dev)
